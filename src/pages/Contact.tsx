      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            <div className="flex items-center justify-center w-12 h-12 bg-blue-600 bg-opacity-10 rounded-full mb-4">
              <Phone className="h-6 w-6 text-blue-600" />
            </div>
            <h3 className="text-xl font-bold text-[#0B1C2D] mb-2">Phone</h3>
            <p className="text-gray-600">032-2256500</p>
            <p className="text-gray-600">0777-235758</p>
            <p className="text-gray-600">070-3356503</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600">info@indusrilankatravels.lk</p>
            <p className="text-gray-600">support@indusrilankatravels.lk</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-[#0B1C2D] py-3 rounded-lg font-bold hover:bg-blue-800 transition-colors flex items-center justify-center space-x-2"
              >
