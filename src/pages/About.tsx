  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mb-16">
          ...
          <div className="max-w-4xl mx-auto text-gray-700 space-y-4 leading-relaxed">
            <p>
              ...
              Indu Sri Lanka Travels has been helping travelers discover the world for over 30 years.
            </p>
            <p>
        ...
        <div>
          <h2 className="text-3xl font-bold text-[#0B1C2D] my-10 text-center">
      ...
      <div className="bg-blue-600 border-b border-gray-700 text-white py-16">
